...
func MarshalProtocol(protocol *TinReqProtocol) ([]byte, []byte, []byte, error) {
...
func marshalJsonHeader(protocol *TinReqProtocol) ([]byte, error) {
...
func marshalJsonBody(protocol *TinReqProtocol) ([]byte, error) {
...
func marshalJsonTail(protocol *TinReqProtocol) ([]byte, error) {
