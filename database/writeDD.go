...
func main() {
	...
	foodTable.AddColumn("name", "string", 255,false, false, false, nil)
	foodTable.AddColumn("price", "int", 0,false, false, false, nil)
	foodTable.AddColumn("stock", "int", 1,false, false, false, nil)
